                                    ...
                                    <div class="u-col u-col-100" style="max-width: 320px; min-width: 550px; display: table-cell; vertical-align: top;">
                                        <div style="height: 100%; width: 100% !important; border-radius: 0px; -webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                            ...
                                            ><!--<![endif]-->
                                                ...
                                                <table id="u_content_text_1" style="font-family: arial, helvetica, sans-serif; margin-top: 30px" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                            ...
                                                            >
                                                                <div class="v-text-align" style="font-size: 14px; color: #333333; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        Hello {{ $judge->fname }},
                                                                        <br><br>
                                                                        We are pleased to inform you that you are one of the judges in {{ $contest->title }} to be held on {{ $contest->date_held_display }} at {{ $contest->venue }}.
                                                                        <br>
                                                                        You can access your account by clicking the button below using the following credentials:
                                                                        <br><br>
                                                                        <strong>Email</strong>: {{ $judge->email }}<br>
                                                                        <strong>Access Key</strong>: {{ $judge->access_key }}
                                                                        <br>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="v-container-padding-padding" style="overflow-wrap: break-word; word-break: break-word; padding: 10px 40px; font-family: arial, helvetica, sans-serif;" align="left">
                                                                ...
                                                                <div class="v-text-align" align="left">
                                                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://unlayer.com" style="height:47px; v-text-anchor:middle; width:456px;" arcsize="6.5%"  strokecolor="#ced4d9" strokeweight="3px" fillcolor="#91a5e2"><w:anchorlock/><center style="color:#000000;"><![endif]-->
                                                                    <a
                                                                        href="{{ config('app.url') }}/authenticate/judge"
                                                                        target="_blank"
                                                                    ...
                                                                    >
                                                                        <span class="v-padding" style="display: block; padding: 15px 40px; line-height: 120%;">
                                                                            <span style="font-size: 14px; line-height: 16.8px;">C L I C K&nbsp; &nbsp;H E R E</span>
                                                                        </span>
                                                                    </a>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            >
                                                                <div class="v-text-align" style="font-size: 14px; color: #333333; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        <span style="font-size: 18px; line-height: 25.2px; font-family: 'Crimson Text', serif;">Feel free to reach out to us with any questions.</span>
                                                                    </p>
                                                                    <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        <span style="font-size: 22px; line-height: 30.8px;">
                                                                            <strong><span style="line-height: 30.8px; font-family: 'Crimson Text', serif; font-size: 22px;">Thanks.</span></strong>
                                                                        </span>
                                                                        <br />
                                                                        <span style="font-size: 18px; line-height: 25.2px; font-family: 'Crimson Text', serif;"></span>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
